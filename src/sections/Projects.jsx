            ...
            return (
              ...
              >
                <div className="group/image relative overflow-hidden bg-slate-950/50">
                  ...
                  <div className="absolute inset-x-0 bottom-4 z-10 flex justify-end gap-2 px-4 opacity-90 translate-y-0 transition-all duration-300 group-hover/image:opacity-100">
